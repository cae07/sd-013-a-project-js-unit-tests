...
describe('6 - Implemente os casos de teste para a função `productDetails`', () => {
  it('Verifica se a função `productDetails` tem o comportamento esperado', () => {
    ...
    assert.deepStrictEqual((Object.values(productDetails())[0].details.productId.includes('123') && Object.values(productDetails())[1].details.productId.includes('123')), true);
  });
});
