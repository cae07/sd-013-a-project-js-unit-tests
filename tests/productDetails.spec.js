...
describe('6 - Implemente os casos de teste para a função `productDetails`', () => {
  it('Verifica se a função `productDetails` tem o comportamento esperado', () => {
    ...
    const id1 = result[0]['details']['productId'].split("").reverse();
    const id2 = result[1]['details']['productId'].split("").reverse();
    ...
    assert.deepStrictEqual([id1[0], id1[1], id1[2], id1[0], id1[1], id1[2]], ['3', '2', '1', '3', '2', '1']);
  });
});
