...
describe('6 - Implemente os casos de teste para a função `productDetails`', () => {
  it('Verifica se a função `productDetails` tem o comportamento esperado', () => {
    ...
    const expected = productDetails('item1', 'item2');
    ...
    assert.deepStrictEqual([expected[0].details.productId.endsWith('123'), expected[1].details.productId.endsWith('123')], [true, true]);
  });
});
