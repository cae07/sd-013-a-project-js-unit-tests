...
describe('6 - Implemente os casos de teste para a função `productDetails`', () => {
  it('Verifica se a função `productDetails` tem o comportamento esperado', () => {
    ...
    const idprod1 = productDetails('Alcool gel', 'Máscara')[0].details.productId.endsWith(123);
    assert.strictEqual(idprod1,true);
    const idprod2 = productDetails('Alcool gel', 'Máscara')[1].details.productId.endsWith(123);
    assert.strictEqual(idprod2,true);
  });
});
