...
describe('6 - Implemente os casos de teste para a função `productDetails`', () => {
  it('Verifica se a função `productDetails` tem o comportamento esperado', () => {
    ...
    assert.deepStrictEqual(productDetails('teste1', 'teste2')[0].details.productId, 'teste1123');
    assert.deepStrictEqual(productDetails('teste1', 'teste2')[1].details.productId, 'teste2123');
  });
});
