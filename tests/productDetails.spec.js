...
describe('6 - Implemente os casos de teste para a função `productDetails`', () => {
  it('Verifica se a função `productDetails` tem o comportamento esperado', () => {
    ...
    // A ideia é acessar o valor do objeto e pesquisar nesse valor a string desejada.
    // Acessando o elemento do objeto na posição [0]..details.productId
    // Com o .slice(-3), seleciona os 3 últimos elementos da string.
