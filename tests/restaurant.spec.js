...
describe('9 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    const menuObj = createMenu(menuInfo);
    const isObject = typeof (menuObj) === 'object';
    const hasFetchMenu = typeof (menuObj.fetchMenu) === 'function';
    assert.strictEqual(isObject && hasFetchMenu, true);
    ...
    objetoRetornado = createMenu(menuInfo);
