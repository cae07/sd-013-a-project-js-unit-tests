...
describe('9 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    // ```
    const objetoRetornado3 = createMenu({ desert: {}, menuKids: {}});
    // objetoRetornado.fetchMenu() // Retorno: objetoQualquer
    assert.deepStrictEqual(objetoRetornado3.fetchMenu(), { desert: {}, menuKids: {}})
    // ```
    // Agora faça o PASSO 1 no arquivo `src/restaurant.js`.
    // --------------------------------------------------------------------------------------
    // TESTE 4: Verifique que 'objetoRetornado.consumption', após a criação do menu, retorna um array vazio.
    // ```
    const objetoRetornado4 = createMenu({ desert: {}, menuKids: {}});
    // objetoRetornado.consumption // Retorno: []
    assert.ok(Array.isArray(objetoRetornado4.consumption));
    ...
    assert.strictEqual(typeof objetoRetornado5.order, 'function')
    ...
    const objetoRetornado8 = createMenu({ food: {}, drink: {} });
    assert.strictEqual(typeof objetoRetornado8.pay, 'function')
    // ```
    objetoRetornado8.order('coxinha');
    objetoRetornado8.order('agua');
    objetoRetornado8.order('coxinha');
    // objetoRetornado.pay() // Retorno: somaDosPreçosDosPedidos
    assert.deepStrictEqual(objetoRetornado8, somaDosPreçosDosPedidos)
    // ```
