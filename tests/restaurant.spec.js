...
describe('9 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    assert.strictEqual(key1, 'food');
    assert.strictEqual(key2, 'drink');
    // objetoRetornado.fetchMenu() // Retorno: { food: {}, drink: {}}
    // ```
    // TESTE 3: Verifique que o menu passado pra função createMenu é identico ao menu recuperado pela função 'objetoRetornado.fetchMenu'
    // ```
    const testObject3 = {food: 'carne', drink: 'coca'};
    const objetoRetornado3 = createMenu(testObject3);
    const verification3 = testObject3 === objetoRetornado3.fetchMenu();
    assert.ok(verification3);
    ...
    // ```
    const objetoRetornado4 = createMenu({food: 'carne', drink: 'coca'});
    assert.deepStrictEqual(objetoRetornado4.comsuption, []);
    ...
    // ```
    const objetoRetornado5 = createMenu({food: 'coxinha', drink: 'coca'});
    ...
    // ```
    const objetoRetornado6 = createMenu({comida: 'peixe', bebida:'coca'});
    ...
    objetoRetornado8.order('coxinha');
    assert.strictEqual(objetoRetornado8.pay(), 11.70);
    // ```
    // objetoRetornado.order('coxinha');
    // objetoRetornado.order('agua');
    // objetoRetornado.order('coxinha');
