...
describe('9 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    // ```
    const objetoRetornado2 = createMenu(testMenu);
    const keyArray = Object.keys(objetoRetornado2.fetchMenu());
    assert.deepStrictEqual(keyArray, ['food', 'drink']);
    // ```
    // TESTE 3: Verifique que o menu passado pra função createMenu é identico ao menu recuperado pela função 'objetoRetornado.fetchMenu'
    // ```
    const objetoRetornado3 = createMenu(testMenu);
    assert.deepStrictEqual(objetoRetornado3.fetchMenu(), testMenu); // Retorno: objetoQualquer
    // ```
    // Agora faça o PASSO 1 no arquivo `src/restaurant.js`.
    // --------------------------------------------------------------------------------------
    // TESTE 4: Verifique que 'objetoRetornado.consumption', após a criação do menu, retorna um array vazio.
    // ```
    const objetoRetornado4 = createMenu(testMenu);
    ...
    // ```
    const objetoRetornado5 = createMenu(testMenu);
    ...
    // ```
    const objetoRetornado6 = createMenu(testMenu);
    ...
    // ```
    const objetoRetornado7 = createMenu(testMenu);
    ...
    // ```
    const objetoRetornado8 = createMenu(testMenu);
