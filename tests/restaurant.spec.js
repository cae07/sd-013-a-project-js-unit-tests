...
describe('9 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    const objetoRetornado2 = createMenu({ food: {}, drink: {} }); // objetoRetornado.fetchMenu() // Retorno: { food: {}, drink: {}}
    assert.deepStrictEqual(objetoRetornado2.fetchMenu(), { food: {}, drink: {} });

    // TESTE 3: Verifique que o menu passado pra função createMenu é identico ao menu recuperado pela função 'objetoRetornado.fetchMenu'
    // const objetoQualquer = {};
    // const objetoRetornado3 = createMenu(objetoQualquer); // objetoRetornado.fetchMenu() // Retorno: objetoQualquer
    ...
    const objetoRetornado4 = createMenu(objetoQualquer); // objetoRetornado.consumption // Retorno: []
