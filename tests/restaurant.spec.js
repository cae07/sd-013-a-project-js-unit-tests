...
// TESTE 1: Verifique se o retorno da função createMenu() é um objeto que possui, 
    ...
    // ```
    const objetoQualquer = { food: 'french fries', drink: 'coke' };
    ...
    objetoRetornado.order('coxinha');
    // eslint-disable-next-line no-unused-expressions
    objetoRetornado.consumption; // Retorno: ["coxinha", "agua", "sopa", "sashimi", "coxinha"];
    ...
    // ```
    const menu = { food: { coxinha: 4, sopa: 4.0, sashimi: 4.5 }, drink: { agua: 2.0 } };
    ...
    assert.strictEqual(objetoRetornado.pay(equalCheck), 'R$11');
    // ```
