...
describe('4 - Implemente os casos de teste para a função `circle`', () => {
  it('Verifica se ao receber um raio, a função `circle` retorna um objeto contedos os valores esperados', () => {
    ...
    // na documentação da w3schools, tem que olhar na definição de uso para entender que deepStrictEqual utiliza-se para objetos e se
    // strictEqual utiliza-se para valores, é bem confuso olhar apenas para a tabela. 
  });
});
